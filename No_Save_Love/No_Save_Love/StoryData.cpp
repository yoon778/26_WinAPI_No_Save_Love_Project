...
void StoryData::Initialize()
{
    ...
    storyScripts[0][0] =
    {
        ...
        { L"{PLAYER}", L"그냥... 내가 할 수 있는 걸 한 것뿐이야." },
        { L"한세아", L"그런 말을 아무렇지 않게 하는 게 더 이상하네." }
    };

    storyScripts[0][1] =
    {
        { L"유하린", L"오, {PLAYER}! 방금 선택 나였지?" },
        { L"{PLAYER}", L"그걸 그렇게 바로 물어봐?" },
    ...
    storyScripts[1][1] =
    {
        { L"유하린", L"{PLAYER}, 너 은근히 나랑 잘 맞는 거 알아?" },
        { L"{PLAYER}", L"갑자기 그런 말을 하면 반응하기 어렵잖아." },
    ...
    storyScripts[2][1] =
    {
        ...
        { L"{PLAYER}", L"괜찮아 보이는 거랑 진짜 괜찮은 건 다르지." },
        { L"유하린", L"...오늘은 장난으로 못 넘기겠네." }
    };

    storyScripts[2][2] =
    {
        { L"서이린", L"{PLAYER}야, 넌 반복이 무섭지 않아?" },
        { L"{PLAYER}", L"무섭지. 그런데 혼자 있는 게 더 무서워." },
        { L"서이린", L"그럼 내 옆에 있어." }
    };
    ...
    storyScripts[3][0] =
    {
        ...
        { L"{PLAYER}", L"혼자서 다 버티지 않아도 된다면 가능하지 않을까." },
