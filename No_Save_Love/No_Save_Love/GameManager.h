...
#include "Scenes/MiniGame3TutorialScene.h"
#include "Scenes/MiniGame4TutorialScene.h"
...
private:
    ...
    MiniGame3TutorialScene minigame3TutorialScene;
    MiniGame4TutorialScene minigame4TutorialScene;
